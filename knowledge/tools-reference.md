...
**Current total tool count:** **207** — see `agent/tests/test_registered_tools_count.py` (`EXPECTED_TOOL_COUNT`). The heading below is historical tier labeling, not a live count.
