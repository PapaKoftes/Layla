...
# Tools Reference — 204 registered tools
...
**Current total tool count:** **195** — see `agent/tests/test_registered_tools_count.py` (`EXPECTED_TOOL_COUNT`). The heading below is historical tier labeling, not a live count.
