...
pre-calibrated User profile in the North Star cannot be represented by this system at all.
...
User default `EDGE=8/NERVE=9/SIGNAL=3`; make the manual-override endpoint + `layla stat` accept the new
