...
This document defines Layla's long-term architecture as a **fully prebuilt local AI companion platform**. All major capabilities ship integrated rather than requiring optional plugins or external setup. See [AGENTS.md](../AGENTS.md), [ARCHITECTURE.md](../ARCHITECTURE.md), and [LAYLA_NORTH_STAR.md](../LAYLA_NORTH_STAR.md) for related context.
