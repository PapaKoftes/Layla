...
- `reference-harness.zip` (~5 MB)  
- `reference-cli.zip` (~10 MB)  

**Extracted to** (GitHub zip = nested folder name):

- `integrations/claude-code-sourcemap-main/claude-code-sourcemap-main/`  
- `integrations/reference-harness/reference-harness/`  
- `integrations/reference-cli/reference-cli/`  
...
Current priority: [state yours — e.g. verify UI checklist / integrate external gateway behind flag / …]
```
