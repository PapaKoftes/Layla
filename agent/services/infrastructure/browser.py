...
def _is_safe_url(url: str) -> bool:
    ...
    obfuscated-IP normalization, scheme allow-list). One source of truth:
    services/safety/url_guard.py. The previous prefix-check missed DNS rebinding and
    decimal/hex-encoded IPs (e.g. http://2130706433/ → 127.0.0.1)."""
    try:
