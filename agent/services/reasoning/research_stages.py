...
from services.reasoning.research_utils import _extract_json_block, normalize_stage_text  # noqa: E402
...
try:
    from services.reasoning.research_intelligence import INTELLIGENCE_ORDER, INTELLIGENCE_RUNNERS
