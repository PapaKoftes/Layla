...
from services.reasoning.research_utils import _extract_json_block, normalize_stage_text
...
def _ensure_brain_dirs() -> None:
    from services.reasoning.research_stages import ensure_research_brain_dirs
    ensure_research_brain_dirs()


def _mark_stage_completed(stage_name: str) -> None:
    from services.reasoning.research_stages import load_mission_state, save_mission_state
