...
class TestGetSummary:
    ...
    def test_summary_counts(self):
        from services.governance.tunnel_audit import get_summary, log_access
        log_access("1.1.1.1", "/a", "GET", None, "allow")
...
class TestPurgeOld:
    def test_purge_empty(self):
        from services.governance.tunnel_audit import purge_old
        count = purge_old(days=1)
        assert count == 0

    def test_purge_recent_keeps(self):
        from services.governance.tunnel_audit import log_access, purge_old, query_log
...
class TestTableCreation:
    ...
    def test_idempotent_creation(self):
        from services.governance.tunnel_audit import _ensure_table, log_access, query_log
        _ensure_table()
