...
class TestClientFromConfig:
    def test_disabled_returns_none(self):
        from services.retrieval.meilisearch_bridge import client_from_config
...
class TestIsAvailable:
    def test_returns_bool(self):
        from services.retrieval.meilisearch_bridge import is_available
...
class TestSearchLearnings:
    ...
    @patch("services.retrieval.meilisearch_bridge.client_from_config")
...
class TestIndexLearning:
    def test_no_client_no_crash(self):
        ...
        from services.retrieval.meilisearch_bridge import index_learning
        # Should not raise
...
class TestDeleteLearning:
    def test_no_client_no_crash(self):
        from services.retrieval.meilisearch_bridge import delete_learning
        delete_learning(cfg={}, rid=1)


class TestGetStats:
    def test_returns_dict(self):
        from services.retrieval.meilisearch_bridge import get_stats
