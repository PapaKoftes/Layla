...
class TestGenerateToken:
    def test_returns_string(self):
        from services.governance.tunnel_auth import generate_token
...
class TestHashToken:
    def test_returns_hex(self):
        from services.governance.tunnel_auth import hash_token
...
class TestValidateToken:
    def test_valid_hashed_token(self):
        from services.governance.tunnel_auth import generate_token, hash_token, validate_token
        token = generate_token()
        h = hash_token(token)
    ...
    def test_invalid_token(self):
        from services.governance.tunnel_auth import hash_token, validate_token
...
class TestRotateToken:
    def test_returns_token_and_hash(self):
        from services.governance.tunnel_auth import hash_token, rotate_token
        cfg = {}
...
class TestIPAllowlist:
    def test_empty_allowlist_allows_all(self):
        from services.governance.tunnel_auth import is_ip_allowed
...
class TestTokenExpiry:
    def test_no_ttl_never_expires(self):
        from services.governance.tunnel_auth import is_token_expired
...
class TestCheckRemoteAccess:
    ...
    def test_denied_bad_token(self):
        from services.governance.tunnel_auth import check_remote_access, hash_token
