...
class TestPermissions:
    def test_valid_permissions(self):
        from services.skills.skill_manifest import VALID_PERMISSIONS, validate_manifest
        m = {"name": "x", "version": "1.0", "description": "d", "entry_point": "e.py",
...
class TestGenerateTemplate:
    def test_template_is_valid(self):
        from services.skills.skill_manifest import generate_template, validate_manifest
