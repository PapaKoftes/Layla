...
class TestDomainExpertise:
    def test_creation(self):
        from services.infrastructure.research_profile import DomainExpertise
...
class TestKnowledgeGap:
    def test_creation(self):
        from services.infrastructure.research_profile import KnowledgeGap
...
class TestResearchProfile:
    def test_round_trip(self):
        from services.infrastructure.research_profile import (
            DomainExpertise,
            KnowledgeGap,
            ResearchProfile,
        )
    ...
    def test_from_dict_empty(self):
        from services.infrastructure.research_profile import ResearchProfile
...
class TestBuildProfile:
    def test_disabled(self):
        from services.infrastructure.research_profile import build_profile
...
class TestSaveLoadProfile:
    def test_save_and_load(self, tmp_path):
        import services.infrastructure.research_profile as mod
        from services.infrastructure.research_profile import (
            DomainExpertise,
            ResearchProfile,
            load_profile,
    ...
    def test_load_nonexistent(self, tmp_path):
        import services.infrastructure.research_profile as mod
        from services.infrastructure.research_profile import load_profile
        original = mod._PROFILE_PATH
...
class TestGetKnowledgeSummary:
    def test_empty_profile(self, tmp_path):
        import services.infrastructure.research_profile as mod
        from services.infrastructure.research_profile import get_knowledge_summary
        original = mod._PROFILE_PATH
...
class TestDetectKnowledgeGaps:
    def test_finds_gaps(self):
        ...
        from services.infrastructure.research_profile import _detect_knowledge_gaps
