...
class TestCheckMemoryCommand:
    def test_non_command_returns_none(self):
        from services.infrastructure.pre_loop_setup import check_memory_command
    ...
    def test_returns_none_on_import_error(self):
        from services.infrastructure.pre_loop_setup import check_memory_command
        with patch.dict("sys.modules", {"services.memory.memory_commands": None}):
...
class TestExtractWorkingMemory:
    def test_does_not_crash(self):
        from services.infrastructure.pre_loop_setup import extract_working_memory
...
class TestCheckContentGuard:
    def test_normal_input_returns_none(self):
        from services.infrastructure.pre_loop_setup import check_content_guard
...
class TestCheckDignity:
    def test_returns_string(self):
        from services.infrastructure.pre_loop_setup import check_dignity
...
class TestBuildPrecomputedRecall:
    def test_no_goal_returns_empty(self):
        from services.infrastructure.pre_loop_setup import build_precomputed_recall
