...
def test_set_cancel_sets_event():
    from shared_state import new_cancel_event, set_cancel, get_cancel_event
...
def test_clear_cancel_removes_event():
    from shared_state import new_cancel_event, clear_cancel, get_cancel_event
...
def test_get_most_recent_conv_id():
    from shared_state import new_cancel_event, get_most_recent_conv_id
