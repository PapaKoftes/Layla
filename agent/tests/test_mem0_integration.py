...
class TestIsAvailable:
    def test_returns_bool(self):
        from services.retrieval.mem0_integration import is_available
        result = is_available()
...
class TestExtractFallback:
    def test_identity_pattern(self):
        from services.retrieval.mem0_integration import _extract_fallback
...
class TestExtractMemories:
    def test_fallback_when_disabled(self):
        from services.retrieval.mem0_integration import extract_memories
...
class TestSearchMemories:
    def test_disabled(self):
        from services.retrieval.mem0_integration import search_memories
...
class TestGetAllMemories:
    def test_disabled(self):
        from services.retrieval.mem0_integration import get_all_memories
...
class TestDeleteMemory:
    def test_disabled(self):
        from services.retrieval.mem0_integration import delete_memory
...
class TestGetStatus:
    def test_disabled(self):
        from services.retrieval.mem0_integration import get_status
