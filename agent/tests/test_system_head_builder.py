...
class TestNeedsGraph:
    def test_related_keyword(self):
        from services.prompts.system_head_builder import needs_graph
...
class TestExtractAspectDomainKeywords:
    def test_with_domains(self):
        from services.prompts.system_head_builder import extract_aspect_domain_keywords
        aspect = {
            "expertise_domains": {
...
class TestBuildExpertiseDomainBlock:
    def test_with_full_domain(self):
        from services.prompts.system_head_builder import build_expertise_domain_block
        aspect = {
            "name": "Echo",
            "expertise_domains": {
...
class TestGetRepoStructure:
    def test_empty_workspace(self):
        from services.prompts.system_head_builder import get_repo_structure
...
class TestDecomposeGoal:
    def test_short_goal_returns_empty(self):
        from services.prompts.system_head_builder import decompose_goal
...
class TestAppendPersonaFocus:
    def test_no_focus_returns_original(self):
        from services.prompts.system_head_builder import append_persona_focus_to_personality
...
class TestRelationshipCodexContext:
    def test_disabled(self):
        from services.prompts.system_head_builder import relationship_codex_context
...
class TestEnrichDeliberationContext:
    def test_empty_context(self):
        from services.prompts.system_head_builder import enrich_deliberation_context
