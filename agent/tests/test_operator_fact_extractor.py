...
def test_malformed_llm_output_stores_nothing(monkeypatch, isolated_db):
    ...
    ow._auto_extract_learnings("my name is User and I work on backend systems", "Nice to meet you.", "morrigan")
    _join_learn_threads()
...
def test_llm_extraction_holds_the_inference_lock(monkeypatch, isolated_db):
    ...
    ow._auto_extract_learnings("my name is User and I work on backend systems", "Hi.", "morrigan")
