...
class TestIsAvailable:
    def test_returns_bool(self):
        from services.workspace.docling_ingest import is_available
        result = is_available()
...
class TestChunkText:
    def test_short_text_single_chunk(self):
        from services.workspace.docling_ingest import chunk_text
...
class TestSupportedFormats:
    def test_returns_list(self):
        from services.workspace.docling_ingest import supported_formats
...
class TestIngestBytes:
    def test_basic_bytes(self):
        from services.workspace.docling_ingest import ingest_bytes
