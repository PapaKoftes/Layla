...
class TestIsRunning:
    def test_returns_bool(self):
        from services.infrastructure.syncthing_sync import is_running
        result = is_running()
...
class TestGetStatus:
    def test_returns_dict(self):
        from services.infrastructure.syncthing_sync import get_status
        status = get_status()
...
class TestGetDeviceId:
    def test_returns_none_when_not_running(self):
        ...
        from services.infrastructure.syncthing_sync import get_device_id
...
class TestTriggerRescan:
    def test_returns_dict(self):
        from services.infrastructure.syncthing_sync import trigger_rescan
...
class TestAddDevice:
    def test_fails_without_server(self):
        from services.infrastructure.syncthing_sync import add_device
