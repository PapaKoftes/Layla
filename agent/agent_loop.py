...
# Constants + _is_lightweight_chat_turn: moved to services/system_head_builder.py
# Imported above.
...
# Helper functions (_load_learnings, _extract_aspect_domain_keywords, etc.):
# Moved to services/system_head_builder.py. Imported above.
...
def _get_tools_for_goal(goal: str, *, context: str = "", workspace_root: str = "", state: dict | None = None) -> frozenset:
    """
    Return tool names for this turn. Applies optional tool_policy (profile,
