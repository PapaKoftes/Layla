...
PLANS = [
    ...
    ("woodworking", "Compare connection strength and use cases in wood"),
    ("woodworking", "Choose lumber and sheet goods by project"),
    ("woodworking", "Sequence cuts for accuracy and safety"),
    ("wood_assembly", "When to use dados, rabbets, and mortise-and-tenon"),
    ("wood_assembly", "Layout and cut wood connections by hand vs machine"),
    ("wood_assembly", "Design for wood movement and grain direction"),
