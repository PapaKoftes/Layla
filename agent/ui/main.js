...
function init() {
  ...
  registerActions({
    ...
    loadKnowledgePacks: settingsFull.loadKnowledgePacks,
    onKnowledgePresetSelect: settingsFull.onKnowledgePresetSelect,
    onKnowledgePackToggle: settingsFull.onKnowledgePackToggle,
    saveKnowledgePacks: settingsFull.saveKnowledgePacks,
    loadApprovalsSafety: settingsFull.loadApprovalsSafety,
    onApprovalModeChange: settingsFull.onApprovalModeChange,
    saveApprovalsSafety: settingsFull.saveApprovalsSafety,
