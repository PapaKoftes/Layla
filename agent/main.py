...
# Activity tracking and scheduler jobs are now in layla.scheduler.*
from layla.scheduler.activity import record_activity as touch_activity  # noqa: E402
...
async def remote_auth_middleware(request: Request, call_next):
    ...
    # Trust loopback ONLY for a direct connection. A tunnel (cloudflared/ngrok)
